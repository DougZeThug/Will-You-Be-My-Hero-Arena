export class PlaybackClock {
 ...
 start(time=0,duration=Infinity){this.time=time;this.duration=duration;this.previous=0;this.alive=true;this.paused=false;cancelAnimationFrame(this.raf);this.raf=requestAnimationFrame(this.tick);}
