...
| Contest kind | Only counted entries add points and **Played**. Exhibitions, replays and Play practice never change the table. | Not applicable: Standings never commits. |
