...
| **Lower graphics quality** | Rebuilds the Watch stage and tones down its contact and camera effects. It also rebuilds The collection's preview, which has no such effects, so the rebuild is all that shows there. Play ignores it. | No. Each visit starts unticked. |
